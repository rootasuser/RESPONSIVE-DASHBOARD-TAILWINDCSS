        ...
        if (!isset($_POST['csrf_token']) || $_POST['csrf_token'] !== $_SESSION['csrf_token']) {
            ...
            if (isset($_POST['add_judge'])) {
                ...
                if (empty($fullname) || empty($username) || empty($password)) {
                    ...
                    $stmt = $conn->prepare("INSERT INTO users (fullname, username, password, role, status) VALUES (:fullname, :username, :password, :role, :status)");
            ...
            if (isset($_POST['delete_id'])) {
                ...
                if (!$delete_id) {
                    ...
                    $stmt = $conn->prepare("DELETE FROM users WHERE id = :id AND role = :role");
            ...
            if (isset($_POST['toggle_id'])) {
                ...
                if (!$toggle_id) {
                    ...
                    $stmt = $conn->prepare("SELECT status FROM users WHERE id = :id AND role = :role");
                    ...
                    $stmt = $conn->prepare("UPDATE users SET status = :status WHERE id = :id AND role = :role");
...
<div class="container mt-5">
    <div class="card border-0">
        <div class="card-header d-flex justify-content-between align-items-center" style="background-color: hsla(227,89%,15%,0.41);">
            <h3></h3>
            <button class="btn btn-primary" data-toggle="modal" data-target="#addJudgeModal">
        ...
        <div class="table-responsive">
            <table id="judgesTable" class="table table">
                <thead>
                    <tr>
                ...
                <?php
try {
    $stmt = $conn->query("SELECT * FROM users WHERE role = 'Judge'");
...
<div class="modal fade" id="addJudgeModal">
